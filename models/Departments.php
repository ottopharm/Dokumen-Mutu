 ...
 * @property QADokLevel3[] $qADokLevel3s
 * @property QADokLevel2[] $qADokLevel2s
 */
class Departments extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('DeptID, Department', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'qADokLevel3s' => array(self::HAS_MANY, 'QADokLevel3', 'DeptID'),
			'qADokLevel2s' => array(self::HAS_MANY, 'QADokLevel2', 'DeptID'),
		);
	}
