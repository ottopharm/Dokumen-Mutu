...
/**
 * This is the model class for table "v_QA_DokLevel3_Dept".
 *
 * The followings are the available columns in table 'v_QA_DokLevel3_Dept':
 ...
 */
class V_DokLevel3_Dept extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('NoDokumen, JudulDokumen, DeptID, JenisDokumen, TglUpload', 'required'),
			...
			array('NoDokumen, JudulDokumen, DeptID, Department, JenisDokumen, TglUpload, UploadBy', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return V_DokLevel3_Dept the static model class
	 */
