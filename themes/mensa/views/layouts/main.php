...
<html lang="en" style="height: 100%">
    ...
    <body class="easyui-layout">
        ...
        <div id="topbar" data-options="region:'north'" class="noBorder text-white">
            <div class="row" style="margin-top:-10px">   
                ...
                <div class="col-md-6" style="text-align:right">
                    <!-- User menu -->
                    <?php if (!empty(Yii::app()->session['loginSession']['userName'])) : ?>
                    ...
                    <?php else : ?>
                        <span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp; 
                        <a href="<?php echo Yii::app()->request->baseUrl . '/admin'; ?>" class="1-btn-text" 
                           style="display:inline-block; margin-top: 12px; color: #FFF; font-weight: bold">Login</a>
                       <?php endif; ?>
        ...
        <!-- LEFT SIDEBAR -->
        <div id="left-side" data-options="region:'west'" title="Main Menu" style="width:240px;padding:5px">
            <?php echo Yii::app()->gc->menuTree(); ?>
